rule CredentialNixPasswdStatic : Credential Nix Passwd {
    ...
    strings:
        $ascii_0 = /^[a-z_][a-z0-9_-]{1,256}\$?:[\$0-9a-z\.\/=,]{2,1024}:[0-9]{1,8}:[0-9]{1,8}:.{0,1024}:\/.{0,1024}:\/?.{0,1024}(\r|\n)+/ ascii nocase
        $ascii_1 = /(\r|\n)+[a-z_][a-z0-9_-]{1,256}\$?:[\$0-9a-z\.\/=,]{2,1024}:[0-9]{1,8}:[0-9]{1,8}:.{0,1024}:\/.{0,1024}:\/?.{0,1024}(\r|\n)+/ ascii nocase
