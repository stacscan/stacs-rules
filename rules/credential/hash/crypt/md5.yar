rule CredentialHashMD5 : Credential Hash MD5 {
    ...
    strings:
        ...
        // these constructs.
        $ascii_0 = /\$1\$[0-9A-Z\.\/]{0,8}\$[0-9A-Z\.\/]{22}/ ascii wide nocase
        $ascii_1 = /\$md5\$[0-9A-Z\.\/]{0,8}\$[0-9A-Z\.\/]{22}/ ascii wide nocase
        $ascii_2 = /\$md5\$[0-9A-Z\.\/]{0,8}\$$[0-9A-Z\.\/]{22}/ ascii wide nocase
        $ascii_3 = /\$md5,rounds=[0-9]+\$[0-9A-Z\.\/]{0,8}\$(\$)?[0-9A-Z\.\/]{22}/ ascii wide nocase
